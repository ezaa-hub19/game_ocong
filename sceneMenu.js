var sceneMenu = new Phaser.Class({
    ...
    init(){},
    preload(){
        this.load.image('bg_start', 'assets/assets/images/bg_start.png');
        this.load.image('btn_play', 'assets/assets/images/btn_play.png');
        this.load.image('title_game', 'assets/assets/images/title_game.png');
        this.load.image('panel_skor', 'assets/assets/images/panel_skor.png');
        this.load.audio('snd_ambience', 'assets/assets/audio/ambience.mp3');
        this.load.audio('snd_touch', 'assets/assets/audio/touch.mp3');
        this.load.audio('snd_transisi_menu', 'assets/assets/audio/transisi_menu.mp3');
    },
